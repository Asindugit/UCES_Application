...
public class DeleteCourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableCourseDetails = new javax.swing.JTable();
        ...
        jLabel1.setText("Delete Couse Details");

        jTableCourseDetails.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jTableCourseDetails.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Course ID", "Course Name", "Lecturer", "Duration", "Course Fee", "Seats"
            }
        ));
        jScrollPane1.setViewportView(jTableCourseDetails);
        ...
        DeleteBtn.setBackground(new java.awt.Color(255, 14, 14));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addContainerGap())
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            .addComponent(DeleteBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(296, 296, 296)))))
        );
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        // Binary search -----------------------------------------------------------
        Course found = CourseBinarySearch.searchByCourseID(courses, searchID);

        // Clear table -------------------------------------------------------------
        DefaultTableModel model = (DefaultTableModel) jTableCourseDetails.getModel();
    ...
    private void DeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtnActionPerformed
        ...
        int selectedRow = jTableCourseDetails.getSelectedRow();

        // Check whether a course is selected --------------------------------------
        if (selectedRow == -1) {

            JOptionPane.showMessageDialog(this, "Please search and select a course first.",
                    "Delete Course", JOptionPane.WARNING_MESSAGE);
            return;
        }

        // Course ID is column 0 ---------------------------------------------------
        String courseID = jTableCourseDetails.getValueAt(selectedRow, 0).toString();
        ...
        boolean deleted = CourseDelete.deleteCourse(courseID);
        ...
        if (deleted) {
            ...
            JOptionPane.showMessageDialog(this, "Course could not be deleted.",
                    "Delete Course", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private javax.swing.JTable jTableCourseDetails;
