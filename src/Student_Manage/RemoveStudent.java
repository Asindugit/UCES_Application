...
import Searching.StudentReader;
...
public class RemoveStudent extends javax.swing.JFrame {
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        // Read students ----------------------------------------------------------- 
        List<Student> students = StudentReader.readStudents();

        // Binary search -----------------------------------------------------------
        Student found = StudentBinarySearch.searchByStudentID(students, searchID);
    ...
    private void DeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtnActionPerformed
        ...
        int selectedRow = jTableStudentDetails.getSelectedRow();

        if (selectedRow == -1) {

            JOptionPane.showMessageDialog(this, "Please search and select a student first.",
                    "Delete Student", JOptionPane.WARNING_MESSAGE);
            return;
        }

        // Student ID is column 0 ----------------------------------------------
        String studentID = jTableStudentDetails.getValueAt(selectedRow, 0).toString();
        ...
        boolean deleted = StudentBinarySearch.deleteStudent(studentID);
