...
public class DeleteUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableUserDetails.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jTableUserDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "User Name", "Gender", "Type", "Contact", "User Name", "Password"
            }
        ));
        jScrollPane1.setViewportView(jTableUserDetails);
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        // Get table model
        DefaultTableModel model = (DefaultTableModel) jTableUserDetails.getModel();
    ...
    private void DeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtnActionPerformed
        ...
        int selectedRow = jTableUserDetails.getSelectedRow();

        if (selectedRow == -1) {

            JOptionPane.showMessageDialog(this, "Please search and select a user first.",
        ...
        // User ID is column 0 -------------------------------------------------
        String userID = jTableUserDetails.getValueAt(selectedRow, 0).toString();
